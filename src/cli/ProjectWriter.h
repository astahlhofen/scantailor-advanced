...
#ifndef SCANTAILOR_CLI_PROJECTWRITER_H_
#define SCANTAILOR_CLI_PROJECTWRITER_H_
...
class ProjectWriter {
 public:
  ProjectWriter(const intrusive_ptr<ProjectPages>& pageSequence, const OutputFileNameGenerator& outFileNameGen);
  ~ProjectWriter();

  bool write(const QString& filePath, const std::vector<intrusive_ptr<AbstractTask>>& tasks) const;
...
#endif  // SCANTAILOR_CLI_PROJECTWRITER_H_
